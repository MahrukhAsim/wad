    ...
    <form action="category.php" method="post" enctype="multipart/form-data">
        <div class="row">
            <div class="d-none d-sm-block col-sm-3 col-md-4 col-lg-2 col-xl-2 mt-auto">
                <label for="brand_title" class="float-md-right"> <span class="d-sm-none d-md-inline"> Category </span> Name:</label>
            </div>
            <div class="col-sm-9 col-md-8 col-lg-4 col-xl-4">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="pro_title" name="cat_title" placeholder="Enter Category Title" >
                </div>
            </div>
        </div>
        <div class="row my-3">
